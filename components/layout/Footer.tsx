...
export default function Footer() {
  ...
  const footerLinks = {
    product: {
      title: '产品',
      links: [
        { name: 'AI生成', href: '/features/ai-generation' },
        { name: '3D展示', href: '/features/3d-viewer' },
        { name: '众筹平台', href: '/features/crowdfunding' },
        { name: '知识产权', href: '/features/ip-protection' }
      ]
    },
    company: {
      title: '公司',
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-gray-400 mb-6 max-w-md">
              AI驱动的文化产品生成平台，从创意到商业化的完整解决方案。让每个人都能成为创作者。
            </p>
